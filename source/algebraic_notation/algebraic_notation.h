...
{
public:
    static bool ParseMove(PieceSet & rPiece, PieceSet & rPromotion, Move& rMove, std::string rInput);

protected:

    static void ProcessTrailingCharacters(std::string & rInput);
    static void ProcessPawnPromotion(PieceSet & rPromotion, std::string & rInput);
